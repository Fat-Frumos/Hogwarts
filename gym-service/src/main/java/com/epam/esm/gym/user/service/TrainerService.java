...
public interface TrainerService {
     ...
     */
    MessageResponse deleteTrainer(String username);
     ...
     * the {@link com.epam.esm.gym.user.dto.profile.UserProfile} of the newly registered trainer.
     */
     ...
     * {@link com.epam.esm.gym.user.dto.trainer.TrainerProfile} of the requested trainer
     */
     ...
     */
    TrainerProfile updateTrainer(String username, UpdateTrainerRequest request);
     ...
     * {@link com.epam.esm.gym.user.dto.trainer.TrainerProfile} for not assigned trainers
     */
     ...
     */
    MessageResponse updateStatusTrainerProfile(String username, Boolean active);
     ...
     *
     * @return a {@link ResponseEntity} containing a list of
     * {@link com.epam.esm.gym.user.dto.trainer.TrainerProfile} for all trainers
     */
     ...
     */
    List<TrainerResponseDto> getActiveTrainersForTrainee(Trainee trainee);
     ...
     * @return a {@link ResponseEntity} containing
     * the list of {@link com.epam.esm.gym.user.dto.trainer.TrainerProfile}
     */
    List<TrainerResponseDto> getNotAssignedTrainers(String username);

    /**
     * Save a new trainer using the provided registration details.
     *
     * @param trainer the registration details for the new trainer
     */
