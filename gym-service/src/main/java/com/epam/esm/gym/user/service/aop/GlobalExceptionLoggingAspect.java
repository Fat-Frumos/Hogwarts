...
public class GlobalExceptionLoggingAspect extends LoggingAspect {
     ...
     */
    @AfterThrowing(pointcut = "com.epam.esm.gym.user.service.aop.Pointcuts.daoLayer()", throwing = "error")
     ...
     * @param error     the thrown exception
     */
    @AfterThrowing(pointcut = "com.epam.esm.gym.user.service.aop.Pointcuts.restEndpoints()", throwing = "error")
