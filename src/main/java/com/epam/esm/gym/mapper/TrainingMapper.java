 ...
 * and converting {@link TrainingType} entities to {@link TrainingTypeResponse}. It also includes methods
 * to create {@link Training} entities from request data.</p>
 */
...
public interface TrainingMapper {
    ...
    /**
     * Converts a {@link TrainingType} entity to a {@link TrainingTypeResponse} DTO.
     *
     * <p>This method maps the details of a {@link TrainingType} entity to a {@link TrainingTypeResponse} DTO.</p>
     *
     * @param trainingType the training type entity to convert
     * @return the converted {@link TrainingTypeResponse}
     */
