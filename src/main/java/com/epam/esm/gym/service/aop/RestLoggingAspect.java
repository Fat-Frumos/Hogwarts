...
public class RestLoggingAspect extends LoggingAspect {
     ...
     */
    @Before("com.epam.esm.gym.service.aop.Pointcuts.controllerLayer()")
     ...
     */
    @Around("com.epam.esm.gym.service.aop.Pointcuts.controllerLayer()")
     ...
     */
    @AfterReturning(pointcut = "com.epam.esm.gym.service.aop.Pointcuts.controllerLayer()", returning = "result")
     ...
     */
    @AfterThrowing(pointcut = "com.epam.esm.gym.service.aop.Pointcuts.controllerLayer()", throwing = "error")
